        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              Sou formado em Engenharia de Software e atualmente curso pós-graduação em 
              Ciência de Dados e Analytics pela PUC-Rio. Tenho paixão por transformar dados 
              em soluções inteligentes e estou em constante evolução na área de tecnologia.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1ePQ2QYzKSupw2eyo21QzrUFjBOl2beBV?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
