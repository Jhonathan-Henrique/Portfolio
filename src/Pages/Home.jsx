...
const WORDS = ["Projetos & Experiencias", "Analise de dados"];
const TECH_STACK = ["Desenvolvimento", "Analise de dados", "Ciência de dados", "Engenharia"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Jhonathan-Henrique" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jhonathan-engineer/" },
  { icon: Instagram, link: "https://www.instagram.com/jhonathan.henriquex/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Todas minhas experiencias em um unico lugar.
                </p>
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  <CTAButton href="https://github.com/Jhonathan-Henrique?tab=repositories" text="Projetos" icon={ExternalLink} />
