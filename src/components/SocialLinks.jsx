...
const socialLinks = [
  {
    ...
    subText: "No LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/jhonathan-engineer/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Jhonathan.HenriqueX",
    icon: Instagram,
    url: "https://www.instagram.com/jhonathan.henriquex/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@JhonathanEngineer",
    icon: Youtube,
    url: "https://www.youtube.com/@jhonathanEngineer",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Jhonathan-Henrique",
    icon: Github,
    url: "https://github.com/Jhonathan-Henrique",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@yt.johnzord",
    color: "black",
